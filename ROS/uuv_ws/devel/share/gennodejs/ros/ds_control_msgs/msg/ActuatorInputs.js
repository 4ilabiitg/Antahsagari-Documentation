...
class ActuatorInputs {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ActuatorInputs(null);
  ...
  static datatype() {
    ...
    return 'ds_control_msgs/ActuatorInputs';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '8406fe33da702cad9efa8ab6b29d67cc';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ActuatorInputs(null);
