...
class Charge {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('charge')) {
        ...
        this.charge = new Array(4).fill(0);
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Check that the constant length array field [charge] has the right length
    if (obj.charge.length !== 4) {
      throw new Error('Unable to serialize array field charge - length must be 4')
    }
    // Serialize message field [charge]
    bufferOffset = _arraySerializer.float32(obj.charge, buffer, bufferOffset, 4);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.charge = _arrayDeserializer.float32(buffer, bufferOffset, 4)
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.charge !== undefined) {
      ...
      resolved.charge = new Array(4).fill(0)
    }
