...
class RawData {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('data_direction')) {
        this.data_direction = initObj.data_direction
      }
      else {
        this.data_direction = 0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [data_direction]
    bufferOffset = _serializer.int8(obj.data_direction, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [data_direction]
    data.data_direction = _deserializer.int8(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    if (msg.data_direction !== undefined) {
      resolved.data_direction = msg.data_direction;
    }
    else {
      resolved.data_direction = 0
    }
