...
(cl:defclass <Ctd> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (conductivity
    ...
    :initform 0.0)
   (conductivity_covar
    :reader conductivity_covar
    :initarg :conductivity_covar
    :type cl:float
    :initform 0.0)
   (temperature
    :reader temperature
   ...
   (salinity
    ...
    :initform 0.0)
   (salinity_covar
    :reader salinity_covar
    :initarg :salinity_covar
    :type cl:float
    :initform 0.0)
   (sound_speed
    :reader sound_speed
    ...
    :initform 0.0)
   (sound_speed_covar
    :reader sound_speed_covar
    :initarg :sound_speed_covar
    :type cl:float
    :initform 0.0))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Ctd>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Ctd)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ds_sensor_msgs-msg:<Ctd> is deprecated: use ds_sensor_msgs-msg:Ctd instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Ctd>))
...
(cl:defmethod ds_header-val ((m <Ctd>))
...
(cl:defmethod conductivity-val ((m <Ctd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ds_sensor_msgs-msg:conductivity-val is deprecated.  Use ds_sensor_msgs-msg:conductivity instead.")
  (conductivity m))

(cl:ensure-generic-function 'conductivity_covar-val :lambda-list '(m))
(cl:defmethod conductivity_covar-val ((m <Ctd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ds_sensor_msgs-msg:conductivity_covar-val is deprecated.  Use ds_sensor_msgs-msg:conductivity_covar instead.")
  (conductivity_covar m))
...
(cl:defmethod temperature_covar-val ((m <Ctd>))
...
(cl:defmethod pressure_covar-val ((m <Ctd>))
...
(cl:defmethod salinity-val ((m <Ctd>))
...
(cl:ensure-generic-function 'salinity_covar-val :lambda-list '(m))
(cl:defmethod salinity_covar-val ((m <Ctd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ds_sensor_msgs-msg:salinity_covar-val is deprecated.  Use ds_sensor_msgs-msg:salinity_covar instead.")
  (salinity_covar m))

(cl:ensure-generic-function 'sound_speed-val :lambda-list '(m))
(cl:defmethod sound_speed-val ((m <Ctd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ds_sensor_msgs-msg:sound_speed-val is deprecated.  Use ds_sensor_msgs-msg:sound_speed instead.")
  (sound_speed m))

(cl:ensure-generic-function 'sound_speed_covar-val :lambda-list '(m))
(cl:defmethod sound_speed_covar-val ((m <Ctd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ds_sensor_msgs-msg:sound_speed_covar-val is deprecated.  Use ds_sensor_msgs-msg:sound_speed_covar instead.")
  (sound_speed_covar m))
(cl:defmethod roslisp-msg-protocol:symbol-codes ((msg-type (cl:eql '<Ctd>)))
    "Constants for message type '<Ctd>"
  '((:CTD_NO_DATA . -9999.0))
)
(cl:defmethod roslisp-msg-protocol:symbol-codes ((msg-type (cl:eql 'Ctd)))
    "Constants for message type 'Ctd"
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Ctd>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'conductivity))))
  ...
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'conductivity_covar))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'salinity))))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 48) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 56) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'salinity_covar))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'sound_speed))))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 48) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 56) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'sound_speed_covar))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Ctd>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'ds_header) istream)
    ...
    (cl:setf (cl:slot-value msg 'conductivity) (roslisp-utils:decode-double-float-bits bits)))
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
      ...
      (cl:setf (cl:ldb (cl:byte 8 48) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 56) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'conductivity_covar) (roslisp-utils:decode-double-float-bits bits)))
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
    ...
    (cl:let ((bits 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 48) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 56) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'salinity_covar) (roslisp-utils:decode-double-float-bits bits)))
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
    ...
    (cl:let ((bits 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 48) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 56) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'sound_speed_covar) (roslisp-utils:decode-double-float-bits bits)))
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Ctd>)))
  ...
  "591691334c96a078caf807c2ffc0c3df")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Ctd)))
  "Returns md5sum for a message object of type 'Ctd"
  "591691334c96a078caf807c2ffc0c3df")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Ctd>)))
  ...
  (cl:format cl:nil "float64 CTD_NO_DATA=-9999.0~%~%# The standard 2-part DsHeader block~%# This allows both a standard ROS header and DS-specific header blocks~%# See HEADERS.md in ds_core_msgs for details~%std_msgs/Header header~%ds_core_msgs/DsHeader ds_header~%~%# Conductivity in S/m~%float64 conductivity~%float64 conductivity_covar~%~%# Temperature in ITS-90 deg C~%float64 temperature~%float64 temperature_covar~%~%# Pressure, in Decibars~%# Pressure-Depth conversions using Fofonoff are emitted using~%# DepthPressure.msg messages~%float64 pressure~%float64 pressure_covar~%~%# Salinity, in psu~%float64 salinity~%float64 salinity_covar~%~%# Speed of Sound~%float64 sound_speed~%float64 sound_speed_covar~%~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: ds_core_msgs/DsHeader~%# This is half our standard header for ds_msgs; see~%# HEADERS.md for details~%~%# This header should ALWAYS be paired with a std_msgs/Header~%# and should ALWAYS reference HEADERS.md.  If you're looking at this~%# file to add headers to a type, you probably want to copy/paste~%# the following block:~%#~%#     # The standard 2-part DsHeader block~%#     # This allows both a standard ROS header and DS-specific header blocks~%#     # See HEADERS.md in ds_core_msgs for details~%#     std_msgs/Header header~%#     ds_core_msgs/DsHeader ds_header~%#~%~%# Time data was received or sent out (i/o time)~%time io_time~%~%# Sensor source UUID~%uint8[16] source_uuid~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Ctd)))
  "Returns full string definition for message of type 'Ctd"
  (cl:format cl:nil "float64 CTD_NO_DATA=-9999.0~%~%# The standard 2-part DsHeader block~%# This allows both a standard ROS header and DS-specific header blocks~%# See HEADERS.md in ds_core_msgs for details~%std_msgs/Header header~%ds_core_msgs/DsHeader ds_header~%~%# Conductivity in S/m~%float64 conductivity~%float64 conductivity_covar~%~%# Temperature in ITS-90 deg C~%float64 temperature~%float64 temperature_covar~%~%# Pressure, in Decibars~%# Pressure-Depth conversions using Fofonoff are emitted using~%# DepthPressure.msg messages~%float64 pressure~%float64 pressure_covar~%~%# Salinity, in psu~%float64 salinity~%float64 salinity_covar~%~%# Speed of Sound~%float64 sound_speed~%float64 sound_speed_covar~%~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: ds_core_msgs/DsHeader~%# This is half our standard header for ds_msgs; see~%# HEADERS.md for details~%~%# This header should ALWAYS be paired with a std_msgs/Header~%# and should ALWAYS reference HEADERS.md.  If you're looking at this~%# file to add headers to a type, you probably want to copy/paste~%# the following block:~%#~%#     # The standard 2-part DsHeader block~%#     # This allows both a standard ROS header and DS-specific header blocks~%#     # See HEADERS.md in ds_core_msgs for details~%#     std_msgs/Header header~%#     ds_core_msgs/DsHeader ds_header~%#~%~%# Time data was received or sent out (i/o time)~%time io_time~%~%# Sensor source UUID~%uint8[16] source_uuid~%~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <Ctd>))
  ...
  (cl:list 'Ctd
    ...
    (cl:cons ':conductivity_covar (conductivity_covar msg))
    ...
    (cl:cons ':salinity_covar (salinity_covar msg))
    (cl:cons ':sound_speed (sound_speed msg))
    (cl:cons ':sound_speed_covar (sound_speed_covar msg))
))
