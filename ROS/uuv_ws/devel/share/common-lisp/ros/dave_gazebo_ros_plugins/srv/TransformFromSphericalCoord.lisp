...
(cl:defmethod cl:initialize-instance :after ((m <TransformFromSphericalCoord-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TransformFromSphericalCoord-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dave_gazebo_ros_plugins-srv:<TransformFromSphericalCoord-request> is deprecated: use dave_gazebo_ros_plugins-srv:TransformFromSphericalCoord-request instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TransformFromSphericalCoord-request>)))
  ...
  "dave_gazebo_ros_plugins/TransformFromSphericalCoordRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TransformFromSphericalCoord-request)))
  "Returns string type for a service object of type 'TransformFromSphericalCoord-request"
  "dave_gazebo_ros_plugins/TransformFromSphericalCoordRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <TransformFromSphericalCoord-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TransformFromSphericalCoord-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dave_gazebo_ros_plugins-srv:<TransformFromSphericalCoord-response> is deprecated: use dave_gazebo_ros_plugins-srv:TransformFromSphericalCoord-response instead.")))

(cl:ensure-generic-function 'output-val :lambda-list '(m))
(cl:defmethod output-val ((m <TransformFromSphericalCoord-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dave_gazebo_ros_plugins-srv:output-val is deprecated.  Use dave_gazebo_ros_plugins-srv:output instead.")
  (output m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TransformFromSphericalCoord-response>)))
  ...
  "dave_gazebo_ros_plugins/TransformFromSphericalCoordResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TransformFromSphericalCoord-response)))
  "Returns string type for a service object of type 'TransformFromSphericalCoord-response"
  "dave_gazebo_ros_plugins/TransformFromSphericalCoordResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TransformFromSphericalCoord)))
  ...
  "dave_gazebo_ros_plugins/TransformFromSphericalCoord")