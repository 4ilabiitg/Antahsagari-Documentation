...
(cl:defmethod cl:initialize-instance :after ((m <TransformToSphericalCoord-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TransformToSphericalCoord-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dave_gazebo_ros_plugins-srv:<TransformToSphericalCoord-request> is deprecated: use dave_gazebo_ros_plugins-srv:TransformToSphericalCoord-request instead.")))

(cl:ensure-generic-function 'input-val :lambda-list '(m))
(cl:defmethod input-val ((m <TransformToSphericalCoord-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dave_gazebo_ros_plugins-srv:input-val is deprecated.  Use dave_gazebo_ros_plugins-srv:input instead.")
  (input m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TransformToSphericalCoord-request>)))
  ...
  "dave_gazebo_ros_plugins/TransformToSphericalCoordRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TransformToSphericalCoord-request)))
  "Returns string type for a service object of type 'TransformToSphericalCoord-request"
  "dave_gazebo_ros_plugins/TransformToSphericalCoordRequest")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<TransformToSphericalCoord-request>)))
  ...
  (cl:format cl:nil "# Copyright (c) 2016 The dave Simulator Authors.~%# All rights reserved.~%#~%# Licensed under the Apache License, Version 2.0 (the \"License\");~%# you may not use this file except in compliance with the License.~%# You may obtain a copy of the License at~%#~%#     http://www.apache.org/licenses/LICENSE-2.0~%#~%# Unless required by applicable law or agreed to in writing, software~%# distributed under the License is distributed on an \"AS IS\" BASIS,~%# WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.~%# See the License for the specific language governing permissions and~%# limitations under the License.~%~%geometry_msgs/Vector3 input~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%# It is only meant to represent a direction. Therefore, it does not~%# make sense to apply a translation to it (e.g., when applying a ~%# generic rigid transformation to a Vector3, tf2 will only apply the~%# rotation). If you want your data to be translatable too, use the~%# geometry_msgs/Point message instead.~%~%float64 x~%float64 y~%float64 z~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'TransformToSphericalCoord-request)))
  "Returns full string definition for message of type 'TransformToSphericalCoord-request"
  (cl:format cl:nil "# Copyright (c) 2016 The dave Simulator Authors.~%# All rights reserved.~%#~%# Licensed under the Apache License, Version 2.0 (the \"License\");~%# you may not use this file except in compliance with the License.~%# You may obtain a copy of the License at~%#~%#     http://www.apache.org/licenses/LICENSE-2.0~%#~%# Unless required by applicable law or agreed to in writing, software~%# distributed under the License is distributed on an \"AS IS\" BASIS,~%# WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.~%# See the License for the specific language governing permissions and~%# limitations under the License.~%~%geometry_msgs/Vector3 input~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%# It is only meant to represent a direction. Therefore, it does not~%# make sense to apply a translation to it (e.g., when applying a ~%# generic rigid transformation to a Vector3, tf2 will only apply the~%# rotation). If you want your data to be translatable too, use the~%# geometry_msgs/Point message instead.~%~%float64 x~%float64 y~%float64 z~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <TransformToSphericalCoord-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TransformToSphericalCoord-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dave_gazebo_ros_plugins-srv:<TransformToSphericalCoord-response> is deprecated: use dave_gazebo_ros_plugins-srv:TransformToSphericalCoord-response instead.")))
...
(cl:defmethod latitude_deg-val ((m <TransformToSphericalCoord-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dave_gazebo_ros_plugins-srv:latitude_deg-val is deprecated.  Use dave_gazebo_ros_plugins-srv:latitude_deg instead.")
  (latitude_deg m))
...
(cl:defmethod longitude_deg-val ((m <TransformToSphericalCoord-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dave_gazebo_ros_plugins-srv:longitude_deg-val is deprecated.  Use dave_gazebo_ros_plugins-srv:longitude_deg instead.")
  (longitude_deg m))

(cl:ensure-generic-function 'altitude-val :lambda-list '(m))
(cl:defmethod altitude-val ((m <TransformToSphericalCoord-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dave_gazebo_ros_plugins-srv:altitude-val is deprecated.  Use dave_gazebo_ros_plugins-srv:altitude instead.")
  (altitude m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TransformToSphericalCoord-response>)))
  ...
  "dave_gazebo_ros_plugins/TransformToSphericalCoordResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TransformToSphericalCoord-response)))
  "Returns string type for a service object of type 'TransformToSphericalCoord-response"
  "dave_gazebo_ros_plugins/TransformToSphericalCoordResponse")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<TransformToSphericalCoord-response>)))
  ...
  (cl:format cl:nil "# Latitude [degrees]. Positive is north of equator; negative is south.~%float64 latitude_deg~%# Longitude [degrees]. Positive is east of prime meridian; negative is west.~%float64 longitude_deg~%# Altitude [m]. Positive is above the WGS 84 ellipsoid~%float64 altitude~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'TransformToSphericalCoord-response)))
  "Returns full string definition for message of type 'TransformToSphericalCoord-response"
  (cl:format cl:nil "# Latitude [degrees]. Positive is north of equator; negative is south.~%float64 latitude_deg~%# Longitude [degrees]. Positive is east of prime meridian; negative is west.~%float64 longitude_deg~%# Altitude [m]. Positive is above the WGS 84 ellipsoid~%float64 altitude~%~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TransformToSphericalCoord)))
  ...
  "dave_gazebo_ros_plugins/TransformToSphericalCoord")