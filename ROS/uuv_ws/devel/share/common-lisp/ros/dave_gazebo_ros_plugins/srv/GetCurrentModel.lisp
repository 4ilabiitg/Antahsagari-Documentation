...
(cl:defmethod cl:initialize-instance :after ((m <GetCurrentModel-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetCurrentModel-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dave_gazebo_ros_plugins-srv:<GetCurrentModel-request> is deprecated: use dave_gazebo_ros_plugins-srv:GetCurrentModel-request instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetCurrentModel-request>)))
  ...
  "dave_gazebo_ros_plugins/GetCurrentModelRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetCurrentModel-request)))
  "Returns string type for a service object of type 'GetCurrentModel-request"
  "dave_gazebo_ros_plugins/GetCurrentModelRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <GetCurrentModel-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetCurrentModel-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dave_gazebo_ros_plugins-srv:<GetCurrentModel-response> is deprecated: use dave_gazebo_ros_plugins-srv:GetCurrentModel-response instead.")))

(cl:ensure-generic-function 'mean-val :lambda-list '(m))
(cl:defmethod mean-val ((m <GetCurrentModel-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dave_gazebo_ros_plugins-srv:mean-val is deprecated.  Use dave_gazebo_ros_plugins-srv:mean instead.")
  (mean m))

(cl:ensure-generic-function 'min-val :lambda-list '(m))
(cl:defmethod min-val ((m <GetCurrentModel-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dave_gazebo_ros_plugins-srv:min-val is deprecated.  Use dave_gazebo_ros_plugins-srv:min instead.")
  (min m))

(cl:ensure-generic-function 'max-val :lambda-list '(m))
(cl:defmethod max-val ((m <GetCurrentModel-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dave_gazebo_ros_plugins-srv:max-val is deprecated.  Use dave_gazebo_ros_plugins-srv:max instead.")
  (max m))

(cl:ensure-generic-function 'noise-val :lambda-list '(m))
(cl:defmethod noise-val ((m <GetCurrentModel-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dave_gazebo_ros_plugins-srv:noise-val is deprecated.  Use dave_gazebo_ros_plugins-srv:noise instead.")
  (noise m))

(cl:ensure-generic-function 'mu-val :lambda-list '(m))
(cl:defmethod mu-val ((m <GetCurrentModel-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dave_gazebo_ros_plugins-srv:mu-val is deprecated.  Use dave_gazebo_ros_plugins-srv:mu instead.")
  (mu m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetCurrentModel-response>)))
  ...
  "dave_gazebo_ros_plugins/GetCurrentModelResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetCurrentModel-response)))
  "Returns string type for a service object of type 'GetCurrentModel-response"
  "dave_gazebo_ros_plugins/GetCurrentModelResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetCurrentModel)))
  ...
  "dave_gazebo_ros_plugins/GetCurrentModel")