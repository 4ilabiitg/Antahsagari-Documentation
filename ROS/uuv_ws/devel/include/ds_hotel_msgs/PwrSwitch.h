...
struct PwrSwitch_
{
  ...
  _ds_header_type ds_header;
   ...
   typedef std::vector< ::ds_hotel_msgs::PwrSwitchDevices_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::ds_hotel_msgs::PwrSwitchDevices_<ContainerAllocator> >> _pwr_devices_type;
