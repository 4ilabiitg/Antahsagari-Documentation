...
"""autogenerated by genpy from ds_core_msgs/Status.msg. Do not edit."""
import codecs
import sys
...
class Status(genpy.Message):
  _md5sum = "8a1dacf20c0ee1eba2ab97fdf58e007f"
  _type = "ds_core_msgs/Status"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """ds_core_msgs/DsHeader ds_header
...
"""
  ...
  __slots__ = ['ds_header','status','descriptive_name']
  _slot_types = ['ds_core_msgs/DsHeader','uint8','string']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       ds_header,status,descriptive_name
    ...
    if args or kwds:
      ...
      if self.status is None:
        self.status = 0
      if self.descriptive_name is None:
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.descriptive_name = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.descriptive_name = str[start:end]
      return self
