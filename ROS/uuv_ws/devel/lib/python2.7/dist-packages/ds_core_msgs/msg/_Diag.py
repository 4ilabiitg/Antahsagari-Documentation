...
"""autogenerated by genpy from ds_core_msgs/Diag.msg. Do not edit."""
import codecs
import sys
...
class Diag(genpy.Message):
  _md5sum = "d0c372bc1fdd3a5f30d93343159c434c"
  _type = "ds_core_msgs/Diag"
...
string value
"""
  __slots__ = ['stamp','source','doubles','strings']
  _slot_types = ['time','string','ds_core_msgs/KeyDouble[]','ds_core_msgs/KeyString[]']
