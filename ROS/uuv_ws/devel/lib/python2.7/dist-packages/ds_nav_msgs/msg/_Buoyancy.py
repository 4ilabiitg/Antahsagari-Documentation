...
"""autogenerated by genpy from ds_nav_msgs/Buoyancy.msg. Do not edit."""
import codecs
import sys
...
class Buoyancy(genpy.Message):
  _md5sum = "8b121cdd301714002177e61b4eab5532"
  _type = "ds_nav_msgs/Buoyancy"
...
"""
  __slots__ = ['header','ds_header','buoyancy']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(Buoyancy, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.buoyancy,) = _get_struct_d().unpack(str[start:end])
      return self
