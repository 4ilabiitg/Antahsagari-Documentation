...
"""autogenerated by genpy from ds_acomms_msgs/AcksExpected.msg. Do not edit."""
import codecs
import sys
...
class AcksExpected(genpy.Message):
  _md5sum = "d41d8cd98f00b204e9800998ecf8427e"
  _type = "ds_acomms_msgs/AcksExpected"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """# Progressive Imagery requires acknowlegement for each
...
# always corresponds to a topside slot."""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(AcksExpected, self).__init__(*args, **kwds)
