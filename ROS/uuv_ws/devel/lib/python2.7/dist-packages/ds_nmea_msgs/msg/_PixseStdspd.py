...
"""autogenerated by genpy from ds_nmea_msgs/PixseStdspd.msg. Do not edit."""
import codecs
import sys
...
class PixseStdspd(genpy.Message):
  _md5sum = "3f028522c0df046dec199efa0c56e7f7"
  _type = "ds_nmea_msgs/PixseStdspd"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """# $PIXSE,STDSPD,x.xxx,y.yyy,z.zzz*hh<CR><LF>
# where:
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PixseStdspd, self).__init__(*args, **kwds)
