...
"""autogenerated by genpy from ds_actuator_msgs/ServoState.msg. Do not edit."""
import codecs
import sys
...
class ServoState(genpy.Message):
  _md5sum = "58f394f19b8d106e399d46eeaa07763e"
  _type = "ds_actuator_msgs/ServoState"
...
"""
  ...
  __slots__ = ['header','ds_header','servo_name','enable','actual_radians','cmd_radians']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,ds_header,servo_name,enable,actual_radians,cmd_radians
    ...
    if args or kwds:
      ...
      if self.enable is None:
        self.enable = False
      if self.actual_radians is None:
        self.actual_radians = 0.
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_B2f().pack(_x.enable, _x.actual_radians, _x.cmd_radians))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.enable, _x.actual_radians, _x.cmd_radians,) = _get_struct_B2f().unpack(str[start:end])
