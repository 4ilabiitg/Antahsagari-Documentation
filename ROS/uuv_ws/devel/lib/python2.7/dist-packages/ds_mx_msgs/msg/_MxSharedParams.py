...
"""autogenerated by genpy from ds_mx_msgs/MxSharedParams.msg. Do not edit."""
import codecs
import sys
...
class MxSharedParams(genpy.Message):
  _md5sum = "69a9cdd30269d12b982d968ec4a6a728"
  _type = "ds_mx_msgs/MxSharedParams"
...
string value
"""
  __slots__ = ['header','ds_header','values']
  _slot_types = ['std_msgs/Header','ds_core_msgs/DsHeader','ds_core_msgs/KeyString[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MxSharedParams, self).__init__(*args, **kwds)
