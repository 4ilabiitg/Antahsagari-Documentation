...
echo_and_run cd "/home/roshan/antah_ws/src/uuv_simulator/uuv_control/uuv_control_cascaded_pids"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/roshan/antah_ws/src/uuv_simulator/uuv_control/uuv_control_cascaded_pids/setup.py" \
     \
    build --build-base "/home/roshan/antah_ws/build/uuv_simulator/uuv_control/uuv_control_cascaded_pids" \
    install \
    --root="${DESTDIR-/}" \
