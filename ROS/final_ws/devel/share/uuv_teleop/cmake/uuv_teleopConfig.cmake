...
if("TRUE" STREQUAL "TRUE")
  set(uuv_teleop_SOURCE_PREFIX /home/roshan/final_ws/src/uuv_simulator/uuv_teleop)
  set(uuv_teleop_DEVEL_PREFIX /home/roshan/final_ws/devel)
  ...
  set(uuv_teleop_INSTALL_PREFIX /home/roshan/final_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'uuv_teleop' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/roshan/final_ws/src/uuv_simulator/uuv_teleop/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT uuv_teleop_NUM_DUMMY_TARGETS)
      set(uuv_teleop_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::uuv_teleop::wrapped-linker-option${uuv_teleop_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR uuv_teleop_NUM_DUMMY_TARGETS "${uuv_teleop_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::uuv_teleop::wrapped-linker-option${uuv_teleop_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND uuv_teleop_LIBRARIES "${interface_target_name}")
